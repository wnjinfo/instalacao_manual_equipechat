...
**Ubuntu Server 24.04 LTS**  (ALTERADO de 22.04 para 24.04)
...
Adicionar repositório (CORRIGIDO: agora usa $(lsb_release -cs) que funciona no 24.04)
```bash
...
sudo apt install -y libxshmfence-dev libgbm-dev wget unzip \
  fontconfig locales libatk1.0-0t64 libc6 libcairo2 libcups2t64 \
...
Considere fazer um pix para nos ajudar, pode ser até com 1 real!
Chave:
```bash
wnjinfo@gmail.com
```
